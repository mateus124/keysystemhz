...
if($serveron1 != "https://linkvertise.com/" || time() - $_SESSION['timetwo'] < 5 || !isset($_SESSION['timetwo'])) {
...
<head>
    ...
    <title>Checkpoint 3-4 / Haunter Z</title>
...
<body>
    ...
    <h3>Checkpoint [ 3 de 4 ]</h3>
    <form action="https://link-center.net/490957/hz-key" method="post" id="form" novalidate="novalidate">
