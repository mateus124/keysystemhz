...
if($serveron1 != "https://linkvertise.com/" || time() - $_SESSION['timethree'] < 5 || !isset($_SESSION['timethree'])) {
    echo "Você não completou o linkversite corretamente, tente novamente.";
    echo '<meta http-equiv="Refresh" Content="4";url="htttps://keyhaunterz.tk/step3.php>"';
    return;
}
...
<head>
    ...
    <title>Checkpoint 4-4 / Haunter Z</title>
...
<body>
    ...
    <h3>Checkpoint [ 4 de 4 ]</h3>
    <form action="https://link-center.net/427924/hz-key" method="post" id="form" novalidate="novalidate">
